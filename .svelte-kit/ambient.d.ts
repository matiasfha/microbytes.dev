...
declare module '$env/static/private' {
	...
	export const npm_package_devDependencies_encoding: string;
	...
	export const npm_package_dependencies_crypto: string;
	...
	export const npm_package_dependencies_reading_time: string;
	export const npm_package_devDependencies__sveltejs_kit: string;
	export const npm_package_devDependencies_svelte_preprocess: string;
	export const npm_package_dependencies__sanity_block_content_to_markdown: string;
	...
	export const npm_package_devDependencies_cloudinary: string;
	...
	export const npm_package_dependencies_util: string;
	export const npm_package_dependencies_utf_8_validate: string;
	export const LSCOLORS: string;
	export const npm_package_dependencies_rss_parser: string;
	export const npm_package_devDependencies__typescript_eslint_parser: string;
	export const npm_package_devDependencies_stream: string;
	export const NPM_TOKEN: string;
	export const PATH: string;
	export const npm_package_dependencies__sanity_block_content_to_html: string;
	export const WARP_PS1: string;
	export const npm_package_devDependencies_simple_svelte_autocomplete: string;
	...
	export const npm_package_devDependencies_esm: string;
	...
	export const npm_package_dependencies_open_graph: string;
	export const npm_config_user_agent: string;
	export const INFOPATH: string;
	export const HOMEBREW_CELLAR: string;
	export const npm_package_dependencies__sveltejs_adapter_cloudflare_workers: string;
...
declare module '$env/dynamic/private' {
	export const env: {
		...
		npm_package_devDependencies_encoding: string;
		...
		npm_package_dependencies_crypto: string;
		npm_package_scripts_dev: string;
		npm_package_devDependencies_postcss_load_config: string;
		npm_config_init_author_email: string;
		npm_package_dependencies_reading_time: string;
		npm_package_devDependencies__sveltejs_kit: string;
		npm_package_devDependencies_svelte_preprocess: string;
		npm_package_dependencies__sanity_block_content_to_markdown: string;
		...
		COMMAND_MODE: string;
		npm_package_devDependencies_cloudinary: string;
		...
		npm_package_dependencies_util: string;
		npm_package_dependencies_utf_8_validate: string;
		LSCOLORS: string;
		npm_package_dependencies_rss_parser: string;
		npm_package_devDependencies__typescript_eslint_parser: string;
		npm_package_devDependencies_stream: string;
		NPM_TOKEN: string;
		PATH: string;
		npm_package_dependencies__sanity_block_content_to_html: string;
		WARP_PS1: string;
		npm_package_devDependencies_simple_svelte_autocomplete: string;
		...
		npm_package_devDependencies_esm: string;
		NODE_PATH: string;
		...
		BUN_INSTALL: string;
		NVM_BIN: string;
		npm_package_dependencies_open_graph: string;
		npm_config_user_agent: string;
		INFOPATH: string;
		HOMEBREW_CELLAR: string;
		npm_package_dependencies__sveltejs_adapter_cloudflare_workers: string;
